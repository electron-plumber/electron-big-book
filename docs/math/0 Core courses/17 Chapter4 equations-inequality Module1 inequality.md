...
1. 传递性：   
   ![img.png](../../public/math/Core%20courses/img.png)           
2. 同向相加性：     
   ![img_1.png](../../public/math/Core%20courses/img_1.png)          
3. 同向皆正相乘性：     
   ![img_3.png](../../public/math/Core%20courses/img_3.png)  
4. 同号倒数性(取倒数时符号反转)：    
   ![img_4.png](../../public/math/Core%20courses/img_4.png)   
   不等式符号反转的性质
   1. 同号倒数    
      若`0<a<b`则`(1/a)>(1/b)`   
      1. 正数的倒数举例：   
...
5. 皆正乘（开）方性：    
   ![img_5.png](../../public/math/Core%20courses/img_5.png)  
...
1. 首先找到两个不等式区间有解就存在交集在找交集  
   ...
   1. x≤(a^{2}+1)
   2. x≥(2a+4)
   ![img_6.png](../../public/math/Core%20courses/img_6.png)  
   交集为：`(2a+4)≤(a^{2}+1)`      
2. 求a的取值范围  
   (2a+4)≤(a^{2}+1)    
   移项    
...
![img_7.png](../../public/math/Core%20courses/img_7.png)  
![img_9.png](../../public/math/Core%20courses/img_9.png)  
![img_10.png](../../public/math/Core%20courses/img_10.png)  
...
![img_8.png](../../public/math/Core%20courses/img_8.png)  
...
2. 求`∆=((6-2k)^{2}-8(3-k))<0`       
   ...
   1. 求根公式（`要简化成最简的表达式否则平方根过大求不出根`）  
      ...
      1. ∆=(-4)^{2}-4·1·3         
         ...
         => 4
      2. x={-b±√∆}/2a    
         ![img_11.png](../../public/math/Core%20courses/img_11.png)   
         1. k_1   
            {-(-4)+√4}/2·1      
            => 4+√4/2    
            => 4+2/2    
...
3. 验证两种解法区间:  
   ...
   3. 联想抛物线图像进行验证推理  
      ![img_13.png](../../public/math/Core%20courses/img_13.png)   
      ![img_14.png](../../public/math/Core%20courses/img_14.png)   
      ![img_15.png](../../public/math/Core%20courses/img_15.png)   
      ![img_22.png](../../public/math/Core%20courses/img_22.png)
...
4. 知识提炼      
   ...
   2. 求根公式：   
      ...
      根的性质依赖于判别式    
      ![img_12.png](../../public/math/Core%20courses/img_12.png)  
   3. 联想抛物线图像验证区间        
